...
public class SportsPlanActivity extends AppCompatActivity {

    Button btnFirstPlan,btnSecondPlan,btnThreePlan;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btnFirstPlan=findViewById(R.id.btn_first_sports_plan);
        btnSecondPlan=findViewById(R.id.btn_second_sports_plan);
        btnThreePlan=findViewById(R.id.btn_three_sports_plan);
        signUpprefer = getSharedPreferences("SignUpData", 0);
        editor = signUpprefer.edit();
        editor.putString("plan_info","9");
        ...
        btnFirstPlan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* editor.putString("plan_due","1");
                editor.putString("plan_cost","2499");
    ...
    public void dialogTermsCondition(){
        final Dialog dialog = new Dialog(SportsPlanActivity.this);
        ...
        txtviewTerms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(SportsPlanActivity.this,TermsAndConditionActivity.class);
                startActivity(i);
            }
        });
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(SportsPlanActivity.this,PayMentGateWay.class);
                startActivity(i);
            }
        });
