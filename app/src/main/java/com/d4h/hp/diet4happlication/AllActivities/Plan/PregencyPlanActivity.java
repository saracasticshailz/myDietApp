...
public class PregencyPlanActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_pregency_diet);

        btnFirstPlan=findViewById(R.id.btn_first_pregency_plan);
        signUpprefer = getSharedPreferences("SignUpData", 0);

        editor = signUpprefer.edit();
        editor.putString("plan_info","4");
...
*/
    ...
    public void dialogTermsCondition(){
        final Dialog dialog = new Dialog(PregencyPlanActivity.this);
        ...
        txtviewTerms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(PregencyPlanActivity.this,TermsAndConditionActivity.class);
                startActivity(i);
            }
        });
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(PregencyPlanActivity.this,PayMentGateWay.class);
                startActivity(i);
            }
        });
