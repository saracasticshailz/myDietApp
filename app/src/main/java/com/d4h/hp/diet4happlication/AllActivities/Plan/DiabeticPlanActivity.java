...
public class DiabeticPlanActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_dibetic_plan);

        btnFirstPlan=findViewById(R.id.btn_first_diabetic_plan);
        signUpprefer = getSharedPreferences("SignUpData", 0);
        editor = signUpprefer.edit();
        editor.putString("plan_info","3");
        btnFirstPlan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              /*  editor.putString("plan_due","3");
    ...
    public void dialogTermsCondition(){
        final Dialog dialog = new Dialog(DiabeticPlanActivity.this);
        ...
        txtviewTerms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(DiabeticPlanActivity.this,TermsAndConditionActivity.class);
                startActivity(i);
            }
        });
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(DiabeticPlanActivity.this,PayMentGateWay.class);
                startActivity(i);
            }
        });
