...
public class KidsPlanActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_kids_diet);

        btnFirstPlan=findViewById(R.id.btn_first_kids_plan);
        signUpprefer = getSharedPreferences("SignUpData", 0);
        editor = signUpprefer.edit();
        editor.putString("plan_info","6");
    ...
    public void dialogTermsCondition(){
        final Dialog dialog = new Dialog(KidsPlanActivity.this);
        ...
        txtviewTerms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(KidsPlanActivity.this,TermsAndConditionActivity.class);
                startActivity(i);
            }
        });
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(KidsPlanActivity.this,PayMentGateWay.class);
                startActivity(i);
            }
        });
