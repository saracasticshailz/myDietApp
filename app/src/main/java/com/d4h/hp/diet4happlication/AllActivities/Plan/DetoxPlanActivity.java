...
public class DetoxPlanActivity extends AppCompatActivity {
    ...
    public void dialogTermsCondition(){
        final Dialog dialog = new Dialog(DetoxPlanActivity.this);
        ...
        txtviewTerms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(DetoxPlanActivity.this,TermsAndConditionActivity.class);
                startActivity(i);
            }
        });
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(DetoxPlanActivity.this,PayMentGateWay.class);
                startActivity(i);
            }
        });
