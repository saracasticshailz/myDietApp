...
public class KetogenicPlanActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_ketogenic_diet);

        btnFirstPlan=findViewById(R.id.btn_first_keto_plan);
        ...
        btnFirstPlan.setOnClickListener(new View.OnClickListener() {
            ...
            /*    editor.putString("plan_due","4");
                editor.putString("plan_cost","8499");
    ...
    public void dialogTermsCondition(){
        final Dialog dialog = new Dialog(KetogenicPlanActivity.this);
        ...
        txtviewTerms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(KetogenicPlanActivity.this,TermsAndConditionActivity.class);
                startActivity(i);
            }
        });
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(KetogenicPlanActivity.this,PayMentGateWay.class);
                startActivity(i);
            }
        });
