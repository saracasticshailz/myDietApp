...
public class SecondScreen extends AppCompatActivity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_secondscreen);
        doctext=findViewById(R.id.doctext);
        docimg=findViewById(R.id.docimg);
        docimg.setOnTouchListener(this);


        Bundle extras = getIntent().getExtras();
        String file_link=extras.getString("view_id");
        if(file_link==""){
       ...
       Glide.with(getApplicationContext())
                .load("https://www.diet4health.in/public/diet4health.in/diet-panel/uploads/"+file_link)
                .into(docimg);
