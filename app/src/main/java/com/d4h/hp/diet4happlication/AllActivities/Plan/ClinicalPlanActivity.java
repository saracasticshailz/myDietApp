...
public class ClinicalPlanActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_clinical_nutri);

        btnFirstPlan=findViewById(R.id.btn_first_clinical_plan);

        signUpprefer = getSharedPreferences("SignUpData", 0);
        editor = signUpprefer.edit();
        editor.putString("plan_info","7");
    ...
    public void dialogTermsCondition(){
        final Dialog dialog = new Dialog(ClinicalPlanActivity.this);
        ...
        txtviewTerms.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(ClinicalPlanActivity.this,TermsAndConditionActivity.class);
                startActivity(i);
            }
        });
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(ClinicalPlanActivity.this,PayMentGateWay.class);
                startActivity(i);
            }
        });
